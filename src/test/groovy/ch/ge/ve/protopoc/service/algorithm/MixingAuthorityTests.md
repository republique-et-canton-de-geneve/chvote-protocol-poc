...
7. generate `omega_hat` and `omega'` _(indices 0 based, so that usage of 'i' is coherent below)_
    1. `omega_hat_0 = 2`, `omega'_0 = 3` _(simulated randomness)_ 
    2. `omega_hat_1 = 4`, `omega'_1 = 0` _(simulated randomness)_
    3. `omega_hat_2 = 1`, `omega'_2 = 1` _(simulated randomness)_ 
...
- `pi = (t, s, bold_c, bold_c_hat)`
    - `t = (t_1, t_2, t_3, (t_{4,1}, t_{4,2}), (t_hat_0, ..., t_hat_2))`
        - `t_1 = 3`
        - `t_2 = 9`
        - `t_3 = 5`
        - `(t_{4,1}, t_{4,2}) = (3, 4)`
...
6. `c_hat = c_hat_{N-1} / (h ^ u) mod p = 3 / (4 ^ 4) mod 11 = 3 * 3 ^ 4 mod 11 = 1`
...
10. `t'_2 = c_hat ^ (-c) * g ^ s_2 mod p = 1 ^ (-4) * 3 ^ 2 mod 11 = 9`
...
13. compute `t_hat'`
    1. `t_hat'_0 = c_hat_0 ^ (-c) * g ^ s_hat_0 * c_hat_{-1} ^ s'_0 mod p` <br>
       `t_hat'_0 = 1 ^ (-4) * 3 ^ 3 * 4 ^ 4 mod 11 = 4` 
    2. `t_hat'_1 = c_hat_1 ^ (-c) * g ^ s_hat_1 * c_hat_0 ^ s'_1 mod p` <br>
       `t_hat'_1 = 1 ^ (-4) * 3 ^ 4 * 1 ^ 3 mod 11 = 4` 
    3. `t_hat'_2 = c_hat_2 ^ (-c) * g ^ s_hat_2 * c_hat_1 ^ s'_2 mod p` <br>
